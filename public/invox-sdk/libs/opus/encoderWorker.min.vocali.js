...
!(function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.EncoderWorker = t() : e.EncoderWorker = t()
    ...
    return (function(e) {
        ...
        "use strict";
        ((function(t) {
            var n, i, s = new Promise((function(e) {
                i = e
            }));
            t.onmessage = (function(e) {
                s.then((function() {
                    switch (e.data.command) {
                        case "encode":
                            n && n.encode(e.data.buffers, t);
                            break;
                        case "done":
                            n && n.encodeFinalFrame();
                            break;
                        case "init":
                            n = new r(e.data, Module)
                    }
                }))
            });
            var r = (function(e, t) {
                if (!t) throw new Error("Module with exports required to initialize an encoder instance");
            ...
            r.prototype.encode = (function(e, dw) {
                for (var t = this.interleave(e), n = 0; n < t.length;) {
                    ...
                    if (this.resampleBuffer.set(t.subarray(n, n + i), this.resampleBufferIndex), n += i, this.resampleBufferIndex += i, this.resampleBufferIndex === this.resampleBufferLength) {
                        ...
                        var s = this._opus_encode_float(this.encoder, this.encoderBufferPointer, this.encoderSamplesPerChannel, this.encoderOutputPointer, this.encoderOutputMaxLength);
                        var packet = new Uint8Array(s);
                        packet.set(this.encoderOutputBuffer.subarray(0, s), 0);
                        if (dw) dw.postMessage(packet);
                        this.resampleBufferIndex = 0
                    }
                }
                return;
                this.buffersInPage++, this.buffersInPage >= this.config.maxBuffersPerPage && this.generatePage()
            }), r.prototype.encodeFinalFrame = (function() {
                for (var e = [], n = 0; n < this.config.numberOfChannels; ++n) e.push(new Float32Array(this.config.bufferLength - this.resampleBufferIndex / this.config.numberOfChannels));
                this.encode(e), this.headerType += 4, this.generatePage(), t.postMessage(null), t.close()
            }), r.prototype.getChecksum = (function(e) {
                for (var t = 0, n = 0; n < e.length; n++) t = t << 8 ^ this.checksumTable[t >>> 24 & 255 ^ e[n]];
                return t >>> 0
            }), r.prototype.generateCommentPage = (function() {
                var e = new DataView(this.segmentData.buffer);
                e.setUint32(0, 1937076303, !0), e.setUint32(4, 1936154964, !0), e.setUint32(8, 10, !0), e.setUint32(12, 1868784978, !0), e.setUint32(16, 1919247474, !0), e.setUint16(20, 21322, !0), e.setUint32(22, 0, !0), this.segmentTableIndex = 1, this.segmentDataIndex = this.segmentTable[0] = 26, this.headerType = 0, this.generatePage()
            }), r.prototype.generateIdPage = (function() {
                var e = new DataView(this.segmentData.buffer);
                e.setUint32(0, 1937076303, !0), e.setUint32(4, 1684104520, !0), e.setUint8(8, 1, !0), e.setUint8(9, this.config.numberOfChannels, !0), e.setUint16(10, 3840, !0), e.setUint32(12, this.config.originalSampleRateOverride || this.config.originalSampleRate, !0), e.setUint16(16, 0, !0), e.setUint8(18, 0, !0), this.segmentTableIndex = 1, this.segmentDataIndex = this.segmentTable[0] = 19, this.headerType = 2, this.generatePage()
            }), 
            r.prototype.generatePage = (
                function() {
                    ...
                    t.postMessage( page, [page.buffer] );
...
function integrateWasmJS() {
    var wasmTextFile = "encoderWorker.min.wast";
    var wasmBinaryFile = "encoderWorker.min.wasm";
    var asmjsCodeFile = "encoderWorker.min.temp.asm.js";
    ...
    function doNativeWasm(global, env, providedBuffer) {
        ...
        if (!Module["wasmBinary"] && typeof WebAssembly.instantiateStreaming === "function" && !isDataURI(wasmBinaryFile) && typeof fetch === "function") {
            WebAssembly.instantiateStreaming(fetch(wasmBinaryFile, {
                ...
                handleError("is mimetype .wasm application/wasm available on the server (Apache, IIS... ) ? If not, enable it on the server that provided this file, maybe need reboot after enable")
